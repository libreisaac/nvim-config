local set_options = {
    ...
    mousetime = 250,                                                       -- Maximum allowable time between consecutive clicks before a multi-click is no longer used (eg: double click)
    ...
    timeoutlen = 250,                                                      -- Timeout in ms for a mapped sequence compleion (default 1,000)

local set_options = {
    ...
    scrolloff = 8,                                                     -- Scroll with the cursor to ensure there's always at least X lines on either side of it
    ...
    sidescrolloff = 8,                                                 -- Scroll with the cursor to ensure there's always at least X columns on either side of it
